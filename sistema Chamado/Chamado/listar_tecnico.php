...
<body>
	...
	<h1 id="formTitulo">Lista de Técnicos</h1>
		    	...
		    	<?php
					...
					<tr>
		      		...
		      		<td style="background-color: #F0F8FF;"><center>
		      			<a class="btn btn-warning btn-sm" href="editar_tecnico.php?id=<?php echo $id ?>" role="button"><i class="far fa-edit"></i>&nbsp;Editar</a>

		      			<a class="btn btn-danger btn-sm" style="color:#fff" href="_deletar_tecnico.php?id=<?php echo $id ?>" role="button"><i class="far fa-trash-alt"></i>&nbsp;Excluir</a>
